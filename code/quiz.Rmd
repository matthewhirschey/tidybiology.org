...
df <- tribble(
    ...
    "Which function can we use to determine if a string contains a particular pattern?", "str_detect()", "easy",
    "Which symbol would you use to add layers in ggplot?", "+", "easy",
    "Which helper function can we use to select variables that begin with a particular pattern?", "starts_with()", "easy",
    "What is considered to be the most complete join?", "full_join()", "easy",
    "Which regular expression means 'start of string'", "^", "easy",
    "Which regular expression means 'end of string'", "$", "easy",
...
fluidPage(
    ...
    fluidRow(
        ...
        column(3,
               ...
               actionButton("question", "Next Question", width = '150px', icon = icon('sync')),
               tags$head(
